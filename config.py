...
ADDRESS = 'YOUR_METAMASK_ADDRESS'
PRIVATE_KEY = 'YOUR_PRIVATE KEY' # Note the '0x' prefix - it must be used

# Do not edit below if not sure
RECEIVER_ADDRESS = '0x81b7e08f65bdf5648606c89998a9cc8164397647' # MetaMask faucet

CONTRACT_ADDRESS = '0x45dc03B71052055b071d3Cc37fE7ceBf8E4bC0D6'
